// // src/pages/StudentAdmissionsPage.tsx
...
//                                 disabled={isMutating}
//                                 onClick={() =>
//                                   accept({ groupId: group._id, studentId: student._id })
//                                 }
...
//                                 disabled={isMutating}
//                                 onClick={() =>
//                                   reject({ groupId: group._id, studentId: student._id })
//                                 }
//                                 className="w-8 h-8 flex items-center justify-center rounded-full transition-all disabled:opacity-40"
