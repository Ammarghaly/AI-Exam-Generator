    ...
    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden">
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-2">
          <span className="text-sm font-bold text-gray-400">Q{question.number}</span>
      ...
      {isCorrect ? (
        <div className="mt-4 bg-green-50 border border-green-200 rounded-xl p-4 flex items-start justify-between">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-red-700 uppercase tracking-wide mb-1">Your Answer</p>
              <p className="text-gray-900 font-semibold line-through">{question.studentAnswer}</p>
            </div>
      ...
      <div className="mt-5 pt-5 border-t border-gray-100 flex items-start gap-3">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          <span className="font-bold text-gray-800">Explanation:</span> {question.explanation}
        </p>
      </div>
    </div>
  );
