    ...
    <>
      ...
      <div className="pt-2">
        <button 
          ...
          className="w-full bg-[#3525cd] hover:bg-[#4f46e5] text-white font-semibold text-base py-3 px-6 rounded-lg shadow-sm transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
        >
